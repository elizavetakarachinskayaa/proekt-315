...
--
-- Хост: 127.0.0.1
-- Время создания: Май 24 2016 г., 08:08
...
--
-- Структура таблицы `category_citys`
--

CREATE TABLE IF NOT EXISTS `category_citys` (
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`,`name`,`url`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Дамп данных таблицы `category_citys`
--

INSERT INTO `category_citys` (`ID`, `name`, `url`) VALUES
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`,`ID_city`,`address`,`telefon`,`driveway`,`characteristic`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
INSERT INTO `city` (`ID`, `ID_city`, `address`, `telefon`, `driveway`, `characteristic`) VALUES
...
INSERT INTO `products` (`ID`, `ID_category`, `name`, `price`, `count`, `characteristic`) VALUES
...
--
-- Структура таблицы `сategory_products`
--

CREATE TABLE IF NOT EXISTS `сategory_products` (
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
--
-- Дамп данных таблицы `сategory_products`
--

INSERT INTO `сategory_products` (`ID`, `name`, `url`) VALUES
(1, 'Духи', 'duxi'),
(2, 'Пудра', 'pudra'),
(3, 'Румяна', 'rumayna'),
